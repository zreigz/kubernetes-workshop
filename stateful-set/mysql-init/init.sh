...
MYSQL_INIT_HOST=${MYSQL_INIT_HOST:-"galera-ss"}
MYSQL_INIT_PORT=${MYSQL_INIT_PORT:-"3306"}
MYSQL_INIT_USERNAME=${MYSQL_INIT_USERNAME:-"myuser"}
MYSQL_INIT_PASSWORD=${MYSQL_INIT_PASSWORD:-"myuserpassword"}
MYSQL_INIT_SCHEMA_DATABASE=${MYSQL_INIT_DATABASE:-"mydatabase"}
